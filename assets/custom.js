(function(a){
  ...
  $('.product__top_description a:first-child').on('click', function () {
...
//   if(d<1){
//     someId.innerHTML = `
//     <div class="announcement_number"><span class="digit">${h}</span><span class="announcement_text">T<span class="hide-small">unnit</span></span></div>
//     <div class="announcement_number"><span class="digit">${m}</span><span class="announcement_text">M<span class="hide-small">inuutit</span></span></div>
//     <div class="announcement_number"><span class="digit">${s}</span><span class="announcement_text">S<span class="hide-small">ekunnit</span></span></div>
//     `
//   }else{
//     someId.innerHTML = `
//     <div class="announcement_number"><span class="digit">${d}</span><span class="announcement_text">P<span class="hide-small">äivää</span></span></div>
//     <div class="announcement_number"><span class="digit">${h}</span><span class="announcement_text">T<span class="hide-small">unnit</span></span></div>
//     <div class="announcement_number"><span class="digit">${m}</span><span class="announcement_text">M<span class="hide-small">inuutit</span></span></div>
//     <div class="announcement_number"><span class="digit">${s}</span><span class="announcement_text">S<span class="hide-small">ekunnit</span></span></div>
//     `
