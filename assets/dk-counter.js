...
// 				Tilaa nyt, niin l&auml;het&auml;mme:
//         </div>
//         <div class="timer__counter">  
//         <span class="time-go">
//         <span class="time-hour"> <strong>${hours} </strong><span class="time__badge">Tunnit</span></span> <code>:</code> 
//         <span class="time-min"> <strong>${min}</strong><span class="time__badge">Minuutit</span></span> <code>:</code> 
//         <span class="time-sec"> <strong>${sec}</strong><span class="time__badge">Sekunnit </span></span> 
//         </span></div></div>`;
...
// 			someId.innerHTML = `<div class="timer__wrapper"><div class="timer__text">Ilmainen toimitus yli 49€ ostoksille</div></div>`;
